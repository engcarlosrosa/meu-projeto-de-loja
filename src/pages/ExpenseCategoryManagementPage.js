// src/pages/ExpenseCategoryManagementPage.js
import React, { useState, useEffect, useCallback } from 'react';
import { doc, getDoc, setDoc } from 'firebase/firestore';
import { useAuth } from '../components/AuthProvider';
import { useFirebase } from '../contexts/FirebaseContext';

const EXPENSE_CATEGORIES_DOC_ID = 'expense_categories';

function ExpenseCategoryManagementPage() {
  ...
  const fetchCategories = useCallback(async () => {
    ...
    setError(null);
    try {
      const docRef = doc(db, 'product_attributes', EXPENSE_CATEGORIES_DOC_ID);
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>Gerenciar Categorias de Despesa</h1>
      ...
      <form onSubmit={handleAddCategory} style={styles.form}>
        ...
        <input type="text" placeholder="Ex: Aluguel, Marketing, Salários" value={newCategory} onChange={(e) => setNewCategory(e.target.value)} required style={styles.input}/>
...
export default ExpenseCategoryManagementPage;
